...
#define AD9834_FSYNC  47   // 帧同步引脚（低有效，控制数据传输开始/结束）
#define AD9834_SCK    48  // 串行时钟引脚（下降沿采样数据，参考🔶1-212）
#define AD9834_SDA    45  // 串行数据引脚（向AD9834写入数据）
...
#define AD9834_MCLK        26000000UL  // 主时钟频率：26MHz（B/C级器件均支持，参考🔶1-51）
